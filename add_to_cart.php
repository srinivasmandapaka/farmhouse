...
$sql_add = "INSERT INTO farmhouse_temp_cart_fh(product_image_url, product_price, no_items, total_item_amount, ip, product_name, customer_id, product_id) values('$image_url','$product_price','$no_items','$total_item_amount','$ip','$product_name','$cu_id', '$product_id')";
$res_added = mysqli_query($conn,$sql_add);
if($res_added){
      //echo "sairam"; //exit;
      //echo "Your product added Successfully";
	  header("Location:jucie.php"); exit;
}
else 
{
//echo "baba";exit;
echo "not added to cart"; exit;
}
}// addtocart
