...
<section class="retail gray group">
	<div class="wrapper">
    	<input type="checkbox" name="retail" checked /> Retail
        <div class="address-list group">
        	<figure class="group">
                <div class="address-no"><input type="radio" name="def-address" checked /> Default Address:</div>
            ...
            <figure class="group add-new-address">
                <div class="address-no"><input type="radio" name="def-address" /> Address 2:</div>
...
<section class="gift-card-check-out border-top group">
	<div class="wrapper">
        ...
        <div class="checkout"><a href="card2.php">Check Out</a></div>
